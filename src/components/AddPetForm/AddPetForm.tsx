...
const AddPetForm = () => {
  ...
  return (
    <div className="flex items-center justify-center rounded-4xl bg-white p-5 pt-7 lg:p-10 xl:flex-1/2 xl:p-0">
      <div className="flex w-full flex-col gap-6 lg:max-w-108 lg:gap-10">
        <div className="flex items-end gap-2">
          ...
          <p className="font-bold text-black/40">Personal details</p>
        </div>
